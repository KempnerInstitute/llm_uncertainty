...
def main(
    *,
    ...
    for i, shard_tups in enumerate(logit_loader):
        ...
        with torch.no_grad():
            ...
            for i in range(no_bins):
                ...
                by_label[str(i)][small_key] = torch.logical_and(
    ...
    if(balanced_classes):
        ...
        filt = {k:v.detach().clone() for k,v in by_label[min_class].items()}
